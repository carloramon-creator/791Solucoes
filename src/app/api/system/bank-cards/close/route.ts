...
export async function POST(req: Request) {
  try {
    ...
    if (card.statement_subcategory_id) {
      ...
      if (subcategory) {
        statementSubcategoryId = subcategory.id;
        statementSubcategoryName = subcategory.name;
        statementCategoryName = subcategory.name;
        statementParentCategoryId = subcategory.parent_id || null;
