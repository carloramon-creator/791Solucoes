                  ...
                  {modal.type === 'financeiro' && modal.subtype === 'saldo-atual' ? (
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            {item.valor !== undefined && (
                              <div className="text-right ml-4">
                                ...
                                {item.tipo === 'conta' && item.overdraft_available_label && (
                                  <p className="mt-1 text-[11px] font-semibold text-sky-600">{item.overdraft_available_label}</p>
                                )}
                              </div>
                            )}
                          </div>
                    ...
                    modal.data.map((item, idx) => (
                      <div key={idx} className="border border-slate-200 rounded-lg p-4 hover:bg-slate-50 transition-colors">
                        ...
                        {modal.type === 'financeiro' && (modal.subtype === 'contas-pagar' || modal.subtype === 'contas-receber') && item?.id && (
